...
#pragma config(Motor,  port1,           fLeft,         tmotorServoContinuousRotation, openLoop, reversed)
#pragma config(Motor,  port2,           bRight,        tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port3,           fRight,        tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port4,           bLeft,         tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port5,           L2Lift,        tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port6,           L1Lift,        tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port7,           rClaw,         tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port8,           R1Lift,        tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port9,           R2Lift,        tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port10,          lClaw,         tmotorServoContinuousRotation, openLoop)
...
void playMap(){
	//clearDebugStream();
writeDebugStreamLine("Playing Map");
