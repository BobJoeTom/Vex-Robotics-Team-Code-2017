...
void userMove()
{
		/*motor[fRight] = (vexRT[Ch3] - vexRT[Ch1] - vexRT[Ch4])/2;
		motor[bRight] =  (vexRT[Ch3] - vexRT[Ch1] + vexRT[Ch4])/2;
		motor[fLeft] = (vexRT[Ch3] + vexRT[Ch1] + vexRT[Ch4])/2;
		motor[bLeft] =  (vexRT[Ch3] + vexRT[Ch1] - vexRT[Ch4])/2;
		*/if(abs(vexRT[Ch1] + vexRT[Ch3] + vexRT[Ch4])>10){
...
void rotate(int speed){//Deg for degrees
			motor[fRight] = speed;
			motor[bRight] =  speed;
			motor[fLeft] = speed;
			motor[bLeft] =  speed;
